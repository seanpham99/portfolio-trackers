        ...
        {success ? (
          ...
          <>
            <CardHeader className="space-y-1 pb-6 pt-8 text-center">
              ...
              <CardDescription className="text-zinc-400">Enter your email to receive reset instructions</CardDescription>
            </CardHeader>
              ...
              >
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      <FieldLabel htmlFor="forgot-email" className="text-zinc-400 font-normal">Email</FieldLabel>
                ...
                <Button type="submit" className="w-full h-11 bg-emerald-600 hover:bg-emerald-500 text-white font-medium shadow-lg shadow-emerald-900/20 mt-2" disabled={loading}>
                  {loading ? <Loader2 className="h-4 w-4 animate-spin" aria-hidden="true" /> : (
                    <span className="flex items-center justify-center">Send Reset Email <ArrowRight className="ml-2 h-4 w-4" aria-hidden="true" /></span>
                  )}
                </Button>
              </fetcher.Form>
